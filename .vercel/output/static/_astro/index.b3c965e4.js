import { g as Ui } from './_commonjsHelpers.725317a4.js';
var $i = { exports: {} },
	T = {};
/**
 * @license React
...
function sc(e) {
	return e === null || typeof e != 'object'
		? null
		: ((e = (Lo && e[Lo]) || e['@@iterator']), typeof e == 'function' ? e : null);
}
var Vi = {
		isMounted: function () {
			return !1;
	...
	Bi = {};
function rt(e, n, t) {
	(this.props = e), (this.context = n), (this.refs = Bi), (this.updater = t || Vi);
}
...
function Ki(e, n, t) {
	...
	if (n != null)
		for (r in (n.ref !== void 0 && (o = n.ref), n.key !== void 0 && (u = '' + n.key), n))
			Qi.call(n, r) && !Wi.hasOwnProperty(r) && (l[r] = n[r]);
				...
				: l != null &&
				  (ju(l) &&
						(l = ac(
							l,
							t +
								(!l.key || (o && o.key === l.key) ? '' : ('' + l.key).replace(Mo, '$&/') + '/') +
								e
						)),
				  n.push(l)),
			1
...
var oe = { current: null },
	yr = { transition: null },
	dc = { ReactCurrentDispatcher: oe, ReactCurrentBatchConfig: yr, ReactCurrentOwner: Fu };
T.Children = {
	map: bt,
...
var He = !(
	...
	Oo = {};
function vc(e) {
	return Bl.call(Oo, e) ? !0 : Bl.call(Do, e) ? !1 : mc.test(e) ? (Oo[e] = !0) : ((Do[e] = !0), !1);
}
function hc(e, n, t, r) {
...
function fs() {
	if (Wn) {
		var e = Wn,
			n = Kn;
		if (((Kn = Wn = null), Vo(e), n)) for (e = 0; e < n.length; e++) Vo(n[e]);
	}
}
function ds(e, n) {
	return e(n);
...
var gs = he.unstable_scheduleCallback,
	...
	Wu = he.unstable_ImmediatePriority,
...
var Le = Math.clz32 ? Math.clz32 : Ic,
	...
	Oc = Math.LN2;
function Ic(e) {
	return (e >>>= 0), e === 0 ? 32 : (31 - ((Dc(e) / Oc) | 0)) | 0;
}
var rr = 64,
	lr = 4194304;
function gt(e) {
...
function ft(e, n) {
	e.blockedOn === n &&
		((e.blockedOn = null),
		uu || ((uu = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, Ac)));
}
function Ot(e) {
	function n(l) {
		return ft(l, e);
...
function Xu(e, n, t, r) {
	if (Dr) {
		var l = ou(e, n, t, r);
		if (l === null) Rl(e, n, r, Or, t), Ho(e, r);
		else if (Vc(l, e, n, t, r)) r.stopPropagation();
		else if ((Ho(e, r), n & 4 && -1 < $c.indexOf(e))) {
			for (; l !== null; ) {
				var u = Gt(l);
				if ((u !== null && Cs(u), (u = ou(e, n, t, r)), u === null && Rl(e, n, r, Or, t), u === l))
					break;
				l = u;
			}
...
var Or = null;
function ou(e, n, t, r) {
	if (((Or = null), (e = Qu(r)), (e = wn(e)), e !== null))
...
function Ds(e, n, t, r) {
	cs(r),
		(n = Ir(n, 'onChange')),
		0 < n.length &&
			((t = new Zu('onChange', 'change', null, t, r)), e.push({ event: t, listeners: n }));
}
var Ct = null,
	It = null;
function gf(e) {
		...
		if (!(n & 7)) {
			e: {
				if (
					...
					p && t !== eu && (w = t.relatedTarget || t.fromElement) && (wn(w) || w[Qe]))
				)
					break e;
				if (
					(g || p) &&
					...
					if (
						...
						(e === 'pointerout' || e === 'pointerover') &&
							((k = Xo), (h = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
						(F = g == null ? p : jn(g)),
						(d = w == null ? p : jn(w)),
			...
			P &&
				(Ls &&
					...
					(On || P !== 'onCompositionStart'
						? P === 'onCompositionEnd' && On && (x = Ts())
						: ((be = v), (Gu = 'value' in be ? be.value : be.textContent), (On = !0))),
				(_ = Ir(c, P)),
				0 < _.length &&
...
var du = typeof setTimeout == 'function' ? setTimeout : void 0,
	...
	Df =
		typeof queueMicrotask == 'function'
			...
			: typeof ii < 'u'
			? function (e) {
					return ii.resolve(null).then(e).catch(Of);
			  }
			: du;
function Of(e) {
	setTimeout(function () {
...
function mn() {
	if (!Dl && $e !== null) {
		...
		try {
			...
			throw ($e !== null && ($e = $e.slice(e + 1)), gs(Wu, mn), l);
		} finally {
			(M = n), (Dl = !1);
		}
	}
	...
	if (j) {
		...
		if (n) {
			...
			if (!fi(e, n)) {
				...
				n = ln(t.nextSibling);
				var r = ve;
				n && fi(e, n) ? Gs(r, t) : ((e.flags = (e.flags & -4097) | 2), (j = !1), (ve = e));
			}
		} else {
			if (vu(e)) throw Error(y(418));
...
function wu(e, n, t, r) {
	var l = e.stateNode;
	(l.props = t), (l.state = e.memoizedState), (l.refs = bs), io(e);
	var u = n.contextType;
	typeof u == 'object' && u !== null
		? (l.context = Ce(u))
...
function na(e) {
	...
	function s(f, a, d, h) {
		...
		return E === Dn
			...
			: a !== null &&
			  (a.elementType === E ||
					(typeof E == 'object' && E !== null && E.$$typeof === Ge && yi(E) === a.type))
						...
						for (var E = d.key, _ = a; _ !== null; ) {
							if (_.key === E) {
								if (((E = d.type), E === Dn)) {
									...
									_.elementType === E ||
									(typeof E == 'object' && E !== null && E.$$typeof === Ge && yi(E) === _.type)
								) {
									t(f, _.sibling),
										(a = l(_, d.props)),
										(a.ref = pt(f, _, d)),
...
function so(e, n) {
	switch ((D(At, n), D(Vt, e), D(je, Zt), (e = n.nodeType), e)) {
		case 9:
		case 11:
...
function po(e, n, t, r, l, u) {
	if (
		...
		(n.updateQueue = null),
		(n.lanes = 0),
		(Er.current = e === null || e.memoizedState === null ? Hf : Qf),
		(e = t(r, l)),
		xt)
	) {
		u = 0;
		do {
			...
			(u += 1), (G = K = null), (n.updateQueue = null), (Er.current = Wf), (e = t(r, l));
		} while (xt);
	}
	if (
		((Er.current = Kr),
...
function ua(e, n) {
	...
	if (
		...
		(r = r.queue),
		vo(sa.bind(null, t, r, e), [e]),
		r.getSnapshot !== n || u || (G !== null && G.memoizedState.tag & 1))
	) {
		if (((t.flags |= 2048), Qt(9, ia.bind(null, t, r, l, n), void 0, null), Z === null))
			throw Error(y(349));
		Pn & 30 || oa(t, n, l);
	}
	return l;
...
function va(e, n, t) {
	return (t = t != null ? t.concat([e]) : null), ul(4, 4, ma.bind(null, n, e), t);
}
function ho() {}
function ha(e, n) {
	var t = _e();
...
function ga(e, n, t) {
	return Pn & 21
		? (Me(t, n) || ((t = Ss()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)), n)
		...
		if (e.lanes === 0 && (u === null || u.lanes === 0) && ((u = n.lastRenderedReducer), u !== null))
			try {
				...
				if (((l.hasEagerState = !0), (l.eagerState = i), Me(i, o))) {
					var s = n.interleaved;
					s === null ? ((l.next = l), oo(n)) : ((l.next = s.next), (s.next = l)),
						(n.interleaved = l);
					return;
				}
			} catch {
...
var Kr = {
	...
	Hf = {
		...
		useImperativeHandle: function (e, n, t) {
			return (t = t != null ? t.concat([e]) : null), Cr(4194308, 4, ma.bind(null, n, e), t);
		},
		...
		useTransition: function () {
			var e = gi(!1),
				n = e[0];
			return (e = Vf.bind(null, e[1])), (Oe().memoizedState = e), [n, e];
		},
...
function Pa(e, n, t) {
	...
	if (r.mode === 'hidden')
		...
		u !== null ? ((r = u.baseLanes | t), (n.memoizedState = null)) : (r = t), D(Hn, pe), (pe |= r);
	...
	if (((i = (o & e.childLanes) !== 0), ae || i)) {
		if (((r = Z), r !== null)) {
			...
			(l = l & (r.suspendedLanes | o) ? 0 : l),
				l !== 0 && l !== u.retryLane && ((u.retryLane = l), We(e, l), Re(r, e, l, -1));
		}
		return Co(), (r = Ul(Error(y(421)))), dr(e, n, o, r);
	}
	return l.data === '$?'
		? ((n.flags |= 128), (n.child = e.child), (n = id.bind(null, e)), (l._reactRetry = n), null)
		: ((e = u.treeContext),
		  (me = ln(l.nextSibling)),
		  (ve = n),
		  (j = !0),
		...
		case 13:
			if (((r = n.memoizedState), r !== null))
				return r.dehydrated !== null
					...
					? Ta(e, n, t)
					: (D(U, U.current & 1), (e = Ke(e, n, t)), e !== null ? e.sibling : null);
			D(U, U.current & 1);
			break;
		case 19:
				...
				if (c === 'style')
					...
					c === 'dangerouslySetInnerHTML'
						...
						: c !== 'suppressContentEditableWarning' &&
						  c !== 'suppressHydrationWarning' &&
						  (Tt.hasOwnProperty(c)
								? (s != null && c === 'onScroll' && O('scroll', e), u || i === s || (u = []))
								: (u = u || []).push(c, s));
		}
		t && (u = u || []).push('style', t);
		var c = u;
							...
							o === 'children'
								? typeof i == 'string'
									...
									: typeof i == 'number' &&
									  ...
									  (u.suppressHydrationWarning !== !0 && ar(r.textContent, i, e),
									  (l = ['children', '' + i]))
								: Tt.hasOwnProperty(o) && i != null && o === 'onScroll' && O('scroll', r);
						}
					switch (t) {
						case 'input':
							nr(r), jo(r, u, !0);
...
function bf(e, n) {
	...
	for (cu = { focusedElem: e, selectionRange: t }, Dr = !1, S = n; S !== null; )
...
function Oa(e) {
	...
	n !== null && ((e.alternate = null), Oa(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null && (delete n[Ie], delete n[$t], delete n[pu], delete n[If], delete n[Ff])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
		...
		case 13:
			Pe(n, e),
				...
				l.flags & 8192 &&
					...
					!u || (l.alternate !== null && l.alternate.memoizedState !== null) || (ko = Q())),
				r & 4 && Li(e);
			break;
		case 22:
			if (
...
function sn(e) {
	return e.mode & 1
		? R & 2 && q !== 0
			...
			: Uf.transition !== null
			? (Pr === 0 && (Pr = Ss()), Pr)
			: ((e = M), e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : zs(e.type))), e)
		: 1;
}
function Re(e, n, t, r) {
	...
	Yt(e, t, r),
		(!(R & 2) || e !== Z) &&
			...
			de(e, r),
			t === 1 && R === 0 && !(n.mode & 1) && ((tt = Q() + 500), rl && mn()));
}
function de(e, n) {
	...
	if (r === 0) t !== null && Bo(t), (e.callbackNode = null), (e.callbackPriority = 0);
		...
		if ((t != null && Bo(t), n === 1))
			e.tag === 0 ? jf(Oi.bind(null, e)) : Ys(Oi.bind(null, e)),
				Df(function () {
					!(R & 6) && mn();
				}),
				(t = null);
...
function $a(e, n) {
	...
	if (r & 30 || r & e.expiredLanes || n) n = Zr(e, r);
		...
		R |= 2;
		var u = Aa();
		(Z !== e || q !== n) && ((Ue = null), (tt = Q() + 500), En(e, n));
		do
			try {
				ld();
				break;
		...
		while (1);
		lo(), (Yr.current = u), (R = l), W !== null ? (n = 0) : ((Z = null), (q = 0), (n = Y));
	}
	if (n !== 0) {
		if ((n === 2 && ((l = lu(e)), l !== 0 && ((r = l), (n = Mu(e, l)))), n === 1))
			throw ((t = Wt), En(e, 0), qe(e, r), de(e, Q()), t);
		if (n === 6) qe(e, r);
		else {
			if (
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
				...
				case 2:
					...
					break;
				case 3:
					if ((qe(e, r), (r & 130023424) === r && ((n = ko + 500 - Q()), 10 < n))) {
						if (Mr(e, 0) !== 0) break;
...
function qe(e, n) {
	for (
		n &= ~wo, n &= ~il, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
		0 < n;
...
function Oi(e) {
	...
	if (t === 1) throw ((t = Wt), En(e, 0), qe(e, n), de(e, Q()), t);
	if (t === 6) throw Error(y(345));
	return (
		(e.finishedWork = e.current.alternate), (e.finishedLanes = n), gn(e, se, Ue), de(e, Q()), null
	);
}
function So(e, n) {
	var t = R;
...
function En(e, n) {
	...
	if ((t !== -1 && ((e.timeoutHandle = -1), Mf(t)), W !== null))
...
function Zr(e, n) {
	...
	while (1);
	if ((lo(), (R = t), (Yr.current = r), W !== null)) throw Error(y(261));
	return (Z = null), (q = 0), Y;
}
function rd() {
	for (; W !== null; ) Ba(W);
...
function Ba(e) {
	...
	(e.memoizedProps = e.pendingProps), n === null ? Ha(e) : (W = n), (go.current = null);
}
function Ha(e) {
	var n = e;
	do {
...
function od(e, n, t) {
	...
	r !== null && r.delete(n),
		...
		Z === e &&
			(q & t) === t &&
			(Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > Q() - ko) ? En(e, 0) : (wo |= t)),
		de(e, n);
}
function Qa(e, n) {
	n === 0 && (e.mode & 1 ? ((n = lr), (lr <<= 1), !(lr & 130023424) && (lr = 4194304)) : (n = 1));
	var t = ue();
	(e = We(e, n)), e !== null && (Yt(e, n, t), de(e, t));
}
function id(e) {
	var n = e.memoizedState,
		t = 0;
	...
	switch (((n.lanes = 0), n.tag)) {
		...
		case 3:
			e: {
				...
				(r = n.pendingProps), (u = n.memoizedState), (l = u.element), qs(e, n), Hr(n, r, null, t);
...
function Nr(e, n, t, r, l, u) {
	...
	if (((r = e), typeof e == 'function')) _o(e) && (o = 1);
		...
		e: switch (e) {
			...
			case Wl:
				return (e = Se(19, t, n, l)), (e.elementType = Wl), (e.lanes = u), e;
			case ns:
				return sl(t, l, u, n);
			default:
...
function sl(e, n, t, r) {
	return (
		(e = Se(22, e, r, n)), (e.elementType = ns), (e.lanes = t), (e.stateNode = { isHidden: !1 }), e
	);
}
function Vl(e, n, t) {
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 && (Ku(n, t | 1), de(n, Q()), !(R & 6) && ((tt = Q() + 500), mn()));
			}
			break;
		case 13:
			zn(function () {
...
var yd = Xi.exports;
const kd = Ui(yd);
export { kd as $, wd as R, yd as a, Yi as r };
