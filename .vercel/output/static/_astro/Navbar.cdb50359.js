import { r as m, R as q, $ as tl } from './index.d4f15412.js';
var Ai = { exports: {} },
	fn = {};
/**
 * @license React
 ...
 */ var nl = m,
	...
	sl = nl.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function Mi(e, t, n) {
	...
	for (r in t) il.call(t, r) && !al.hasOwnProperty(r) && (o[r] = t[r]);
	if (e && e.defaultProps) for (r in ((t = e.defaultProps), t)) o[r] === void 0 && (o[r] = t[r]);
	return { $$typeof: rl, type: e, key: s, ref: i, props: o, _owner: sl.current };
}
fn.Fragment = ol;
fn.jsx = Mi;
fn.jsxs = Mi;
...
function Vi() {
	return typeof q.useSyncExternalStore == 'function'
		? q.useSyncExternalStore(ml, hl, pl)
		: m.useContext(ll);
}
function Ri(e, t, n) {
...
function Li(e) {
	...
	if (typeof e == 'string' || typeof e == 'number') r += e;
		...
		if (Array.isArray(e))
			for (t = 0; t < e.length; t++) e[t] && (n = Li(e[t])) && (r && (r += ' '), (r += n));
		else for (t in e) e[t] && (r && (r += ' '), (r += t));
	return r;
}
function gl() {
	for (var e, t, n = 0, r = ''; n < arguments.length; )
		(e = arguments[n++]) && (t = Li(e)) && (r && (r += ' '), (r += t));
	return r;
}
...
const yl = new Set(['id']),
	bl = new Set(['aria-label', 'aria-labelledby', 'aria-describedby', 'aria-details']),
	xl = new Set(['href', 'target', 'rel', 'download', 'ping', 'referrerPolicy']),
	wl = /^(data-.*)$/;
function Ni(e, t = {}) {
	...
	for (const i in e)
		Object.prototype.hasOwnProperty.call(e, i) &&
			(yl.has(i) || (n && bl.has(i)) || (r && xl.has(i)) || o?.has(i) || wl.test(i)) &&
			(s[i] = e[i]);
	return s;
}
function ze(e) {
	if (Pl()) e.focus({ preventScroll: !0 });
	else {
		let t = Tl(e);
		e.focus(), Sl(t);
	}
...
const Ml = m.createContext({ isNative: !0, open: Ll });
function kl() {
	return m.useContext(Ml);
}
function Vl(e, t) {
...
function ut(e, t, n = !0) {
	...
	(ut.isOpening = n), ze(e), e.dispatchEvent(u), (ut.isOpening = !1);
}
ut.isOpening = !1;
function Rl(e, t) {
...
const Wi = q.createContext(null);
Wi.displayName = 'PressResponderContext';
function jl({ children: e }) {
	return q.createElement(Wi.Provider, { value: void 0 }, e);
}
class Bl {
	isDefaultPrevented() {
...
function Jr(e) {
	(Ge = !0), Wl(e) && ((dt = 'keyboard'), xr('keyboard', e));
}
function Ze(e) {
	(dt = 'pointer'),
...
function zl(e) {
	Kn(e) && ((Ge = !0), (dt = 'virtual'));
}
function Kl(e) {
	e.target === window ||
		e.target === document ||
		(!Ge && !Hn && ((dt = 'virtual'), xr('virtual', e)), (Ge = !1), (Hn = !1));
}
function Ul() {
	(Ge = !1), (Hn = !0);
}
function Gn() {
	...
	(HTMLElement.prototype.focus = function () {
		...
		document.addEventListener('click', zl, !0),
...
typeof document < 'u' &&
	(document.readyState !== 'loading' ? Gn() : document.addEventListener('DOMContentLoaded', Gn));
function Ui() {
	return dt !== 'pointer';
}
function Hl() {
...
function Gl(e, t, n) {
	return !(e && t === 'keyboard' && n instanceof KeyboardEvent && !_l[n.key]);
}
function Yl(e, t, n) {
	Gn(),
		m.useEffect(() => {
			let r = (o, s) => {
				Gl(n?.isTextInput, o, s) && e(Ui());
			};
			return (
				Un.add(r),
				() => {
	...
	if (!(typeof document > 'u'))
		return (
			typeof PointerEvent < 'u'
				...
				: document.addEventListener('touchend', Yn),
			Tn++,
			() => {
				Tn--,
					!(Tn > 0) &&
						(typeof PointerEvent < 'u'
							...
							: document.removeEventListener('touchend', Yn));
			}
		);
}
function Zl(e) {
...
function Hi(e) {
	if (Hl() === 'virtual') {
		...
		ji(() => {
			document.activeElement === t && document.contains(e) && ze(e);
		});
	} else ze(e);
}
function Ql(e) {
...
function Gi(e, t) {
	return (
		e.nodeName !== '#comment' && Ql(e) && eu(e, t) && (!e.parentElement || Gi(e.parentElement, e))
	);
}
...
function tu(e) {
	let { children: t, contain: n, restoreFocus: r, autoFocus: o } = e,
		...
		u = m.useMemo(() => new qn({ scopeRef: a }), [a]);
	pe(() => {
		let d = l || te.root;
	...
	return {
		focusNext(t = {}) {
			let n = e.current,
				...
				u = Me(Ke(n), { tabbable: o, accept: i }, n);
		...
		focusFirst(t = {}) {
			let n = e.current,
				...
				s = Me(Ke(n), { tabbable: r, accept: o }, n);
...
const wr = [
	...
	ru = wr.join(':not([hidden]),') + ',[tabindex]:not([disabled]):not([hidden])';
wr.push('[tabindex]:not([tabindex="-1"]):not([disabled])');
const ou = wr.join(':not([hidden]):not([tabindex="-1"]),');
function Ke(e) {
...
function Qt(e, t = !0) {
	let n = e[0].previousElementSibling,
		r = Me(Ke(e), { tabbable: t }, e);
	r.currentNode = n;
	let o = r.nextNode();
	t && !o && ((r = Me(Ke(e), { tabbable: !1 }, e)), (r.currentNode = n), (o = r.nextNode())), xe(o);
}
function su(e, t) {
	const n = q.useRef(t);
	m.useEffect(() => {
...
function au(e, t, n) {
	pe(() => {
		...
		let r = e.current,
			o = (s) => {
				let i = s.target;
				ie(i, e.current) ? (X = e) : Yi(i) || (X = null);
			};
		return (
		...
		pe(() => {
			...
			let o = (s) => {
				...
				if (
					...
					s.preventDefault(), s.stopPropagation(), u ? xe(u, !0) : Yi(a) ? xe(a, !0) : i.blur();
				}
			};
			return (
					...
					() => {
						...
						if (
							...
							(ie(document.activeElement, e.current) ||
								(document.activeElement === document.body && lu(e)))
						) {
							let s = te.clone();
							requestAnimationFrame(() => {
	...
	*traverse(t = this.root) {
	...
	constructor() {
		(this.fastMap = new Map()),
			(this.root = new qn({ scopeRef: null })),
...
function Xi(e = {}) {
	let { autoFocus: t = !1, isTextInput: n, within: r } = e,
		o = m.useRef({ isFocused: !1, isFocusVisible: t || Ui() }),
		[s, i] = m.useState(!1),
	...
	let { focusProps: f } = Ki({ isDisabled: r, onFocusChange: c }),
		{ focusWithinProps: d } = Xl({ isDisabled: !r, onFocusWithinChange: c });
	return { isFocused: s, isFocusVisible: a, focusProps: r ? d : f };
}
let cu = q.createContext(null);
function fu(e) {
	let t = m.useContext(cu) || {};
	Bi(t, e);
	let { ref: n, ...r } = t;
	return r;
}
function qi(e, t) {
	...
	return (
		m.useEffect(() => {
			a.current && t.current && Hi(t.current), (a.current = !1);
		}, [t]),
		{
			focusableProps: ue(
...
function hu(e) {
	...
	return (
		e.disableFocusManagement ||
			(a = q.createElement(tu, { restoreFocus: !0, contain: o && !r }, a)),
		(a = q.createElement(du.Provider, { value: i }, q.createElement(jl, null, a))),
		tl.createPortal(a, n)
	);
}
function De(e) {
...
var Zi = (e, t, n = !0) => {
	...
	mu = (e, t) => JSON.stringify(e) === JSON.stringify(t);
function Ji(e, t) {
	e.forEach(function (n) {
		Array.isArray(n) ? Ji(n, t) : t.push(n);
	});
}
function Qi(e) {
	let t = [];
...
function yu(e) {
	...
	function s(a) {
		var l = a.split(Sr);
		return l[0] === '' && l.length !== 1 && l.shift(), ts(l, t) || bu(a);
	}
	function i(a, l) {
		var u = n[a] || [];
...
function xu(e) {
	var t = e.theme,
		...
		o = Pu(Object.entries(e.classGroups), n);
	return (
...
function Eu(e) {
	return { cache: Tu(e.cacheSize), splitModifiers: Su(e), ...yu(e) };
}
var $u = /\s+/;
function Au(e, t) {
...
function Jn() {
	...
	function a(u) {
		...
		return (r = Eu(d)), (o = r.cache.get), (s = r.cache.set), (i = l), l(u);
	}
	function l(u) {
		var c = o(u);
		if (c) return c;
...
var rs = /^\[(?:([a-z-]+):)?(.+)\]$/i,
	Mu = /^\d+\/\d+$/,
	ku = new Set(['px', 'full', 'screen']),
	Vu = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,
	Ru =
		/\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,
	Lu = /^-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/;
function me(e) {
	return Ue(e) || ku.has(e) || Mu.test(e) || Qn(e);
}
function Qn(e) {
	return Ye(e, 'length', ju);
}
function Du(e) {
	return Ye(e, 'size', os);
}
function Nu(e) {
	return Ye(e, 'position', os);
}
function Fu(e) {
	return Ye(e, 'url', Bu);
}
...
function er() {
	...
	return {
		...
		theme: {
			...
			gradientColorStopPositions: [Ou, Qn],
			inset: T(),
			margin: T(),
			opacity: g(),
			padding: E(),
		...
		classGroups: {
			...
			'bg-position': [{ bg: [].concat(V(), [Nu]) }],
			'bg-repeat': [{ bg: ['no-repeat', { repeat: ['', 'x', 'y', 'round', 'space'] }] }],
			'bg-size': [{ bg: ['auto', 'cover', 'contain', Du] }],
			'bg-image': [
				{ bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, Fu] },
			],
			'bg-color': [{ bg: [e] }],
			...
			shadow: [{ shadow: ['', 'inner', 'none', Ee, Iu] }],
...
var Hu = Jn(er),
	Gu = { twMerge: !0, twMergeConfig: {}, responsiveVariants: !1 },
	ss = (e) => e || void 0,
	en = (...e) => ss(Qi(e).filter(Boolean).join(' ')),
	Cn = null,
	tn = {},
	tr = !1,
	gt =
		(...e) =>
		(t) =>
			t.twMerge ? ((!Cn || tr) && ((tr = !1), (Cn = se(tn) ? Hu : Uu(tn))), ss(Cn(en(e)))) : en(e),
	ao = (e, t) => {
		...
		let {
			...
			f =
				n != null && n.defaultVariants && !se(n.defaultVariants)
					? { ...n.defaultVariants, ...a }
					: a;
		!se(l.twMergeConfig) && !mu(l.twMergeConfig, tn) && ((tr = !0), (tn = l.twMergeConfig));
				...
				let C = (T, E, x = [], P) => {
							...
							for (let R in E)
								if (E.hasOwnProperty(R) && R === P) {
									...
									if (j && typeof j == 'string') {
										let I = ro(j);
										V[P]
											? (V[P] = V[P].concat(I.split(' ').map((W) => `${T}:${W}`)))
											: (V[P] = I.split(' ').map((W) => `${T}:${W}`));
									} else
										Array.isArray(j) &&
											j.length > 0 &&
											(V[P] = j.reduce((I, W) => I.concat(`${T}:${W}`), []));
								}
						}
						return V;
					},
					S = (T, E = c, x = null, P = null) => {
						...
						let I = no(j),
							...
							fe = f?.[T],
							g = [];
						if (typeof I == 'object' && W)
							for (let [L, z] of Object.entries(I)) {
								let K = R[z];
								if (L === 'initial') {
									fe = z;
									continue;
				...
				let N = (T, E) => {
					...
					D = (T = [], E) => {
						...
						for (let { class: P, className: V, ...R } of T) {
							let j = !0;
							for (let [I, W] of Object.entries(R)) {
								let fe = N(I, E);
								if (Array.isArray(W)) {
									if (!W.includes(fe[I])) {
										j = !1;
						...
						for (let { slots: x = [], class: P, className: V, ...R } of i) {
							if (!se(R)) {
								...
								for (let I of Object.keys(R)) {
									let W = N(I, T)[I];
									if (W === void 0 || (Array.isArray(R[I]) ? !R[I].includes(W) : R[I] !== W)) {
										j = !1;
										break;
									}
								}
	...
	uo = as({
		base: ['relative inline-flex items-center outline-none tap-highlight-transparent', ...ls],
		variants: {
	...
	qu = 'flex mx-1 text-current self-center';
function us(e) {
	var t,
		n,
		r = '';
...
var Ju = Object.create,
	...
	ds = (e, t) =>
		function () {
			return t || (0, e[fs(e)[0]])((t = { exports: {} }).exports, t), t.exports;
		},
	nc = (e, t, n, r) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let o of fs(t))
				!tc.call(e, o) &&
					o !== n &&
					cs(e, o, { get: () => t[o], enumerable: !(r = Qu(t, o)) || r.enumerable });
		return e;
	},
	rc = (e, t, n) => (
		(n = e != null ? Ju(ec(e)) : {}),
		nc(t || !e || !e.__esModule ? cs(n, 'default', { value: e, enumerable: !0 }) : n, e)
	),
	oc = ds({
		'../../../node_modules/.pnpm/react@18.2.0/node_modules/react/cjs/react.production.min.js'(e) {
			...
			function k(g, $, L) {
				var z,
					...
					J = null;
				if ($ != null)
					for (z in ($.ref !== void 0 && (J = $.ref), $.key !== void 0 && (U = '' + $.key), $))
						N.call($, z) && !p.hasOwnProperty(z) && (K[z] = $[z]);
				...
				if (g && g.defaultProps)
					for (z in ((Q = g.defaultProps), Q)) K[z] === void 0 && (K[z] = Q[z]);
				return { $$typeof: t, type: g, key: U, ref: J, props: K, _owner: D.current };
			}
			function _(g, $) {
			...
			function V(g, $, L, z, K) {
				...
				if (((J = 0), (z = z === '' ? '.' : z + ':'), M(g)))
					...
					for (g = G.call(g), Q = 0; !(U = g.next()).done; )
						(U = U.value), (G = z + P(U, Q++)), (J += V(U, $, L, G, K));
				else if (U === 'object')
					throw (
						(($ = String(g)),
						Error(
			...
			var I = { current: null },
				W = { transition: null },
				fe = { ReactCurrentDispatcher: I, ReactCurrentBatchConfig: W, ReactCurrentOwner: D };
			(e.Children = {
				map: R,
				...
				(e.cloneElement = function (g, $, L) {
					...
					return { $$typeof: t, type: g.type, key: K, ref: U, props: z, _owner: J };
				}),
				...
				(e.useCallback = function (g, $) {
					return I.current.useCallback(g, $);
				}),
				(e.useContext = function (g) {
					return I.current.useContext(g);
				}),
				(e.useDebugValue = function () {}),
				(e.useDeferredValue = function (g) {
					return I.current.useDeferredValue(g);
				}),
				(e.useEffect = function (g, $) {
					return I.current.useEffect(g, $);
				}),
				(e.useId = function () {
					return I.current.useId();
				}),
				(e.useImperativeHandle = function (g, $, L) {
					return I.current.useImperativeHandle(g, $, L);
				}),
				(e.useInsertionEffect = function (g, $) {
					return I.current.useInsertionEffect(g, $);
				}),
				(e.useLayoutEffect = function (g, $) {
					return I.current.useLayoutEffect(g, $);
				}),
				(e.useMemo = function (g, $) {
					return I.current.useMemo(g, $);
				}),
				(e.useReducer = function (g, $, L) {
					return I.current.useReducer(g, $, L);
				}),
				(e.useRef = function (g) {
					return I.current.useRef(g);
				}),
				(e.useState = function (g) {
					return I.current.useState(g);
				}),
				(e.useSyncExternalStore = function (g, $, L) {
					return I.current.useSyncExternalStore(g, $, L);
				}),
 ...
 */ var co = rc(ic()),
	...
	hs = q.createContext(null);
hs.displayName = 'PressResponderContext';
var ac = Object.defineProperty,
	lc = (e, t, n) =>
		t in e ? ac(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
	Ie = (e, t, n) => (lc(e, typeof t != 'symbol' ? t + '' : t, n), n),
	ps = (e, t, n) => {
		if (!t.has(e)) throw TypeError('Cannot ' + n);
	},
	uc = (e, t, n) => (ps(e, t, 'read from private field'), n ? n.call(e) : t.get(e)),
	cc = (e, t, n) => {
		if (t.has(e)) throw TypeError('Cannot add the same private member more than once');
		t instanceof WeakSet ? t.add(e) : t.set(e, n);
	},
	fc = (e, t, n, r) => (ps(e, t, 'write to private field'), r ? r.call(e, n) : t.set(e, n), n),
	Kt,
	Ft = class {
		constructor(e, t, n) {
			Ie(this, 'type'),
...
function fo(e) {
	if (Oi()) {
		if (ot === 'default') {
			const t = We(e);
			(rr = t.documentElement.style.webkitUserSelect),
			...
			setTimeout(() => {
				ji(() => {
					if (ot === 'restoring') {
						const t = We(e);
						t.documentElement.style.webkitUserSelect === 'none' &&
							(t.documentElement.style.webkitUserSelect = rr || ''),
							(rr = ''),
							(ot = 'default');
					}
				});
...
function ms(e) {
	let {
		...
		{ addGlobalListener: b, removeAllGlobalListeners: C } = Dl(),
		S = tt((p, k) => {
			let _ = y.current;
						...
						if (
							...
							if (
								...
								!p.ignoreClickAfterPress &&
									...
									!p.isPressed &&
									(p.pointerType === 'virtual' || Kn(T.nativeEvent)))
							) {
								!i && !l && ze(T.currentTarget);
								let x = S(T, 'virtual'),
									P = A(T, 'virtual'),
									V = w(T, 'virtual');
								E = x && P && V;
			...
			if (typeof PointerEvent < 'u') {
				...
				(k.onMouseDown = (x) => {
					...
					(p.isPressed = !0),
						...
						(p.pointerType = Kn(x.nativeEvent) ? 'virtual' : 'mouse'),
						!i && !l && ze(x.currentTarget),
				...
				(k.onTouchStart = (x) => {
					...
					(p.activePointerId = P.identifier),
						...
						c || fo(p.target),
						S(x, p.pointerType) && x.stopPropagation(),
						b(nr(x.currentTarget), 'scroll', E, !0);
				}),
					(k.onTouchMove = (x) => {
						if (!x.currentTarget.contains(x.target)) return;
						if (!p.isPressed) {
...
function En(e, t) {
	...
	return (
		...
		!(
			(o instanceof nr(o).HTMLInputElement && !gs(o, n)) ||
			o instanceof nr(o).HTMLTextAreaElement ||
			o.isContentEditable
		) &&
...
function gs(e, t) {
	return e.type === 'checkbox' || e.type === 'radio' ? t === ' ' : gc.has(e.type);
}
var vc = (e) =>
	O.jsxs('svg', {
		'aria-hidden': 'true',
		...
		...e,
		children: [
			O.jsx('path', { d: 'M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6' }),
			O.jsx('path', { d: 'M15 3h6v6' }),
			O.jsx('path', { d: 'M10 14L21 3' }),
		],
	});
const vs = m.createContext({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: 'never' }),
	hn = m.createContext({}),
	pn = m.createContext(null),
	mn = typeof document < 'u',
	Er = mn ? m.useLayoutEffect : m.useEffect,
	ys = m.createContext({ strict: !1 });
function yc(e, t, n, r) {
	const { visualElement: o } = m.useContext(hn),
		s = m.useContext(ys),
		i = m.useContext(pn),
		a = m.useContext(vs).reducedMotion,
		l = m.useRef();
	(r = r || s.renderer),
		!l.current &&
			r &&
...
function wc(e) {
	const { initial: t, animate: n } = xc(e, m.useContext(hn));
...
const Mr = m.createContext({}),
	xs = m.createContext({}),
	Tc = Symbol.for('motionComponentSymbol');
function Sc({
	preloadedFeatures: e,
	...
	function s(a, l) {
		let u;
		const c = { ...m.useContext(vs), ...a, layoutId: Cc(a) },
			{ isStatic: f } = c,
			d = wc(a),
			h = r(a, f);
		if (!f && mn) {
			d.visualElement = yc(o, h, c, t);
			const v = m.useContext(xs),
				y = m.useContext(ys).strict;
		...
		return m.createElement(
			...
			n(o, a, bc(h, d.visualElement, l), h, f, d.visualElement)
		);
	}
...
function kr(e) {
	return typeof e != 'string' || e.includes('-') ? !1 : !!($c.indexOf(e) > -1 || /[A-Z]/.test(e));
}
const nn = {};
function Ac(e) {
	Object.assign(nn, e);
...
const ce = (e) => !!(e && e.getVelocity),
	Mc = { x: 'translateX', y: 'translateY', z: 'translateZ', transformPerspective: 'perspective' },
	kc = Mt.length;
function Vc(e, { enableHardwareAcceleration: t = !0, allowTransformNone: n = !0 }, r, o) {
	let s = '';
	for (let i = 0; i < kc; i++) {
		const a = Mt[i];
		if (e[a] !== void 0) {
...
const Ps = (e) => (t) => typeof t == 'string' && t.startsWith(e),
	Ts = Ps('--'),
	or = Ps('var(--'),
	Rc = /var\s*\(\s*--[\w-]+(\s*,\s*(?:(?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)+)?\s*\)/g,
	Lc = (e, t) => (t && typeof e == 'number' ? t.transform(e) : e),
...
function Vr(e, t, n, r) {
	...
	if (
		(t.transform ||
			(l || r ? (o.transform = Vc(e.transform, n, c, r)) : o.transform && (o.transform = 'none')),
		u)
	) {
...
function Es(e, t, n) {
	for (const r in t) !ce(t[r]) && !ws(r, n) && (e[r] = t[r]);
}
function Oc({ transformTemplate: e }, t, n) {
	return m.useMemo(() => {
		const r = Rr();
...
function Ic(e, t, n) {
	const r = e.style || {},
		o = {};
	return Es(o, r, e), Object.assign(o, Oc(e, t, n)), e.transformValues ? e.transformValues(o) : o;
}
function jc(e, t, n) {
	const r = {},
		o = Ic(e, t, n);
...
let $s = (e) => !rn(e);
function _c(e) {
	e && ($s = (t) => (t.startsWith('on') ? !rn(t) : e(t)));
}
try {
...
const Kc = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
	Uc = { offset: 'strokeDashoffset', array: 'strokeDasharray' };
function Hc(e, t, n = 1, r = 0, o = !0) {
	e.pathLength = 1;
	const s = o ? Kc : Uc;
...
function Lr(
	...
	h.transform && (y && (v.transform = h.transform), delete h.transform),
		y &&
			...
			(v.transformOrigin = zc(y, o !== void 0 ? o : 0.5, s !== void 0 ? s : 0.5)),
		t !== void 0 && (h.x = t),
		n !== void 0 && (h.y = n),
		r !== void 0 && (h.scale = r),
		i !== void 0 && Hc(h, i, a, l, !1);
}
const As = () => ({ ...Rr(), attrs: {} }),
...
function Gc(e, t, n, r) {
	...
	if (e.style) {
		const s = {};
		Es(s, e.style, e), (o.style = { ...s, ...o.style });
	}
	return o;
}
function Yc(e = !1) {
	return (n, r, o, { latestValues: s }, i) => {
		const l = (kr(n) ? Gc : jc)(r, s, i, n),
			c = { ...Wc(r, typeof n == 'string', e), ...l, ref: o },
			{ children: f } = r,
...
function Ms(e, { style: t, vars: n }, r, o) {
...
function Vs(e, t, n, r) {
	Ms(e, t, void 0, r);
	for (const o in t.attrs) e.setAttribute(ks.has(o) ? o : Nr(o), t.attrs[o]);
}
function Fr(e, t) {
	const { style: n } = e,
		r = {};
	for (const o in n) (ce(n[o]) || (t.style && ce(t.style[o])) || ws(o, e)) && (r[o] = n[o]);
	return r;
}
function Rs(e, t) {
	const n = Fr(e, t);
...
const on = (e) => Array.isArray(e),
	Xc = (e) => !!(e && typeof e == 'object' && e.mix && e.toValue),
	qc = (e) => (on(e) ? e[e.length - 1] || 0 : e);
function Ht(e) {
	const t = ce(e) ? e.get() : e;
	return Xc(t) ? t.toValue() : t;
}
function Zc({ scrapeMotionValuesFromProps: e, createRenderState: t, onMount: n }, r, o, s) {
	const i = { latestValues: Jc(r, o, s, e), renderState: t() };
...
function tf(e, t) {
	...
	const o = { delta: 0, timestamp: 0, isProcessing: !1 },
		s = jt.reduce((f, d) => ((f[d] = Qc(() => (n = !0))), f), {}),
		i = (f) => s[f].process(o),
		a = () => {
			const f = performance.now();
			(n = !1),
				(o.delta = r ? 1e3 / 60 : Math.max(Math.min(f - o.timestamp, ef), 1)),
				(o.timestamp = f),
				(o.isProcessing = !0),
				jt.forEach(i),
				(o.isProcessing = !1),
...
const {
		...
		state: re,
		steps: An,
	} = tf(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : ee, !0),
	nf = {
		useVisualState: Ds({
	...
	rf = { useVisualState: Ds({ scrapeMotionValuesFromProps: Fr, createRenderState: Rr }) };
function of(e, { forwardMotionProps: t = !1 }, n, r) {
	return {
		...(kr(e) ? nf : rf),
		preloadedFeatures: n,
		useRender: Yc(t),
...
const sf = (e) => (t) => Ns(t) && e(t, bn(t));
function Te(e, t, n, r) {
	return we(e, t, sf(n), r);
}
const af = (e, t) => (n) => t(e(n)),
	ke = (...e) => e.reduce(af);
function Fs(e) {
	let t = null;
	return () => {
...
const js = (e, t) => (t ? (e === t ? !0 : js(e, t.parentElement)) : !1);
function Mn(e, t) {
	if (!t) return;
				...
				const r = this.node.getProps(),
					s = Te(
						...
						(a, l) => {
							...
							H.update(() => {
								js(this.node.current, a.target) ? u && u(a, l) : c && c(a, l);
							});
						},
...
class gf extends Fe {
	...
	startObserver() {
		...
		const { viewport: t = {} } = this.node.getProps(),
			...
			i = {
				...
				rootMargin: r,
				threshold: typeof o == 'number' ? o : mf[o],
			},
			a = (l) => {
		...
		return pf(this.node.current, i, a);
	}
	mount() {
		this.startObserver();
	}
	update() {
		...
		['amount', 'margin', 'root'].some(vf(t, n)) && this.startObserver();
	}
	unmount() {}
}
...
function xn(e, t, n) {
	const r = e.getProps();
	return Or(r, t, n !== void 0 ? n : r.custom, bf(e), xf(e));
}
const wf = 'framerAppearId',
	Pf = 'data-' + Nr(wf);
let Tf = ee,
	Ir = ee;
const Ve = (e) => e * 1e3,
	Se = (e) => e / 1e3,
	Sf = { current: !1 },
	_s = (e) => Array.isArray(e) && typeof e[0] == 'number';
function Ws(e) {
	return !!(!e || (typeof e == 'string' && zs[e]) || _s(e) || (Array.isArray(e) && e.every(Ws)));
}
...
function Ks(e) {
	if (e) return _s(e) ? xt(e) : Array.isArray(e) ? e.map(Ks) : zs[e];
}
function Cf(
	e,
	t,
...
function Ef(e, { repeat: t, repeatType: n = 'loop' }) {
	const r = t && n !== 'loop' && t % 2 === 1 ? 0 : e.length - 1;
	return e[r];
}
const Us = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e,
	$f = 1e-7,
	Af = 12;
function Mf(e, t, n, r, o) {
	let s,
		i,
		a = 0;
	do (i = t + (n - t) / 2), (s = Us(i, r, o) - e), s > 0 ? (n = i) : (t = i);
	while (Math.abs(s) > $f && ++a < Af);
	return i;
}
function Rt(e, t, n, r) {
	if (e === t && n === r) return ee;
	const o = (s) => Mf(s, 0, 1, e, n);
	return (s) => (s === 0 || s === 1 ? s : Us(o(s), t, r));
}
const kf = Rt(0.42, 0, 1, 1),
	Vf = Rt(0, 0, 0.58, 1),
	Hs = Rt(0.42, 0, 0.58, 1),
	...
	jr = Ys(Xs),
	Lf = Gs(jr),
	qs = Rt(0.33, 1.53, 0.69, 0.99),
	Br = Ys(qs),
	Df = Gs(Br),
	Nf = (e) => ((e *= 2) < 1 ? 0.5 * Br(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1)))),
	Ff = {
		linear: ee,
		easeIn: kf,
		easeInOut: Hs,
	...
	Of = (e) => Re(0, 255, e),
	Vn = { ...qe, transform: (e) => Math.round(Of(e)) },
	He = {
		test: _r('rgb', 'red'),
...
const sr = { test: _r('#'), parse: If, transform: He.transform },
	st = {
		test: _r('hsl', 'hue'),
	...
	ae = {
		test: (e) => He.test(e) || sr.test(e) || st.test(e),
		parse: (e) => (He.test(e) ? He.parse(e) : st.test(e) ? st.parse(e) : sr.parse(e)),
...
function jf({ hue: e, saturation: t, lightness: n, alpha: r }) {
	(e /= 360), (t /= 100), (n /= 100);
	let o = 0,
		s = 0,
		i = 0;
...
const Ln = (e, t, n) => {
	...
	Bf = [sr, He, st],
	_f = (e) => Bf.find((t) => t.test(e));
function Eo(e) {
	const t = _f(e);
	let n = t.parse(e);
	return t === st && (n = jf(n)), n;
}
const Js = (e, t) => {
	const n = Eo(e),
		r = Eo(t),
...
function Wf(e) {
	...
	return (
		...
		(((t = e.match(yn)) === null || t === void 0 ? void 0 : t.length) || 0) +
			(((n = e.match(Ss)) === null || n === void 0 ? void 0 : n.length) || 0) >
			0
	);
}
const Qs = { regex: Rc, countKey: 'Vars', token: '${v}', parse: ee },
	ea = { regex: Ss, countKey: 'Colors', token: '${c}', parse: ae.parse },
	ta = { regex: yn, countKey: 'Numbers', token: '${n}', parse: qe.parse };
...
function sn(e) {
	...
	return n.value.includes('var(--') && Dn(n, Qs), Dn(n, ea), Dn(n, ta), n;
}
function na(e) {
	return sn(e).values;
}
function ra(e) {
	...
	return (i) => {
		...
		for (let l = 0; l < s; l++)
			l < r
				? (a = a.replace(Qs.token, i[l]))
				: l < r + n
				? (a = a.replace(ea.token, ae.transform(i[l])))
				: (a = a.replace(ta.token, Pt(i[l])));
		return a;
	};
}
const zf = (e) => (typeof e == 'number' ? 0 : e);
function Kf(e) {
	const t = na(e);
	return ra(e)(t.map(zf));
}
const Le = { test: Wf, parse: na, createTransformer: ra, getAnimatableNone: Kf },
	oa = (e, t) => (n) => `${n > 0 ? t : e}`;
function ia(e, t) {
...
const sa = (e, t) => {
	...
	Uf = (e, t) => {
		const n = { ...e, ...t },
			r = {};
		for (const o in n) e[o] !== void 0 && t[o] !== void 0 && (r[o] = ia(e[o], t[o]));
		return (o) => {
...
function la(e, t, { clamp: n = !0, ease: r, mixer: o } = {}) {
	const s = e.length;
...
function an({ duration: e = 300, keyframes: t, times: n, ease: r = 'easeInOut' }) {
	const o = Rf(r) ? r.map(Co) : Co(r),
		s = { done: !1, value: t[0] },
		i = qf(n && n.length === t.length ? n : Xf(t), e),
		a = la(i, t, { ease: Array.isArray(o) ? o : Zf(t, o) });
...
function od(e, t, n) {
	let r = n;
	for (let o = 1; o < rd; o++) r = r - e(r) / t(r);
	return r;
}
function ar(e, t) {
...
function fa({ keyframes: e, restDelta: t, restSpeed: n, ...r }) {
	const o = e[0],
		s = e[e.length - 1],
		i = { done: !1, value: o },
		{
...
const ud = { decay: ko, inertia: ko, tween: an, keyframes: an, spring: fa };
function ln({
	autoplay: e = !0,
	delay: t = 0,
	driver: n = ld,
	...
	const w = ud[o] || an;
	let A;
	w !== an && typeof r[0] != 'number' && ((A = la([0, 100], r, { clamp: !1 })), (r = [0, 100]));
	...
	const V = (g) => {
			...
			if (s) {
				...
				const Gr = !!(oe % 2);
				Gr && (a === 'reverse' ? ((Oe = 1 - Oe), i && (Oe -= i / E)) : a === 'mirror' && (K = N));
				let Yr = Re(0, 1, Oe);
				P > x && (Yr = a === 'reverse' && Gr ? 1 : 0), (z = Yr * E);
			}
			const U = L ? { done: !1, value: r[0] } : K.next(z);
			A && (U.value = A(U.value));
			let { done: J } = U;
			!L && T !== null && (J = h >= 0 ? P >= x : P <= 0);
			const Q = p === null && (D === 'finished' || (D === 'running' && J));
			return f && f(U.value), Q && I(), U;
		},
		R = () => {
			S && S.stop(), (S = void 0);
		},
...
const fd = cd(() => Object.hasOwnProperty.call(Element.prototype, 'animate')),
	dd = new Set(['opacity', 'clipPath', 'filter', 'transform', 'backgroundColor']),
	Bt = 10,
	hd = 2e4,
	pd = (e, t) => t.type === 'spring' || e === 'backgroundColor' || !Ws(t.ease);
function md(e, t, { onUpdate: n, onComplete: r, ...o }) {
	if (
		!(
			fd() &&
			dd.has(t) &&
	...
	if (pd(t, o)) {
		...
		const A = [];
		let M = 0;
		for (; !w.done && M < hd; ) (w = S.sample(M)), A.push(w.value), (M += Bt);
		(h = void 0), (c = A), (f = M - Bt), (d = 'linear');
	}
	const v = Cf(e.owner.current, t, c, { ...o, duration: f, ease: d, times: h });
	o.syncStart &&
...
function gd({ keyframes: e, delay: t, onUpdate: n, onComplete: r }) {
	const o = () => (
		n && n(e[e.length - 1]),
		r && r(),
		{
...
const vd = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
	yd = (e) => ({
		type: 'spring',
		stiffness: 550,
	...
	bd = { type: 'keyframes', duration: 0.8 },
	xd = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
	wd = (e, { keyframes: t }) =>
		t.length > 2 ? bd : Xe.has(e) ? (e.startsWith('scale') ? yd(t[1]) : vd) : xd,
	lr = (e, t) =>
		e === 'zIndex'
			? !1
			: !!(
	...
	Pd = new Set(['brightness', 'contrast', 'saturate', 'opacity']);
function Td(e) {
...
function da(e, t) {
	let n = Wr(e);
	return n !== ur && (n = Le), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
const ha = (e) => /^0[^.\s]+$/.test(e);
function Ed(e) {
	if (typeof e == 'number') return e === 0;
	if (e !== null) return e === 'none' || e === '0' || ha(e);
}
function $d(e, t, n, r) {
	const o = lr(t, n);
	let s;
...
class Hr {
	...
	add(t) {
		return Kr(this.subscriptions, t), () => Ur(this.subscriptions, t);
	}
	notify(t, n, r) {
...
class kd {
	constructor(t, n = {}) {
		(this.version = '10.16.4'),
			...
			(this.canTrackVelocity = Md(this.current)),
			(this.owner = n.owner);
	}
	onChange(t) {
	...
	getVelocity() {
		return this.canTrackVelocity
			? ua(parseFloat(this.current) - parseFloat(this.prev), this.timeDelta)
			: 0;
	}
	start(t) {
		return (
...
const ga = (e) => (t) => t.test(e),
	Vd = { test: (e) => e === 'auto', parse: (e) => e },
	va = [qe, F, ye, $e, Fc, Nc, Vd],
	vt = (e) => va.find(ga(e)),
	Rd = [...va, ae, Le],
	Ld = (e) => Rd.find(ga(e));
function Dd(e, t, n) {
				...
				c === null &&
					(c =
						(o = (r = n[l]) !== null && r !== void 0 ? r : e.readValue(l)) !== null && o !== void 0
							...
							: t[l]),
				c != null &&
					(typeof c == 'string' && (ma(c) || ha(c))
						? (c = parseFloat(c))
						: !Ld(c) && Le.test(u) && (c = da(l, u)),
...
function ya(e, t, { delay: n = 0, transitionOverride: r, type: o } = {}) {
	let {
		...
		Array.from(e.variantChildren)
			...
			.forEach((u, c) => {
				u.notify('AnimationStart', t),
					i.push(cr(u, t, { ...s, delay: n + l(c) }).then(() => u.notify('AnimationComplete', t)));
			}),
		Promise.all(i)
	);
}
...
function Wd(e, t, n = {}) {
	...
	let r;
	if (Array.isArray(t)) {
		const o = t.map((s) => cr(e, s, n));
		r = Promise.all(o);
	} else if (typeof t == 'string') r = cr(e, t, n);
	else {
		const o = typeof t == 'function' ? xn(e, t, n.custom) : t;
		r = Promise.all(ya(e, o, n));
	}
...
const zd = [...$r].reverse(),
	Kd = $r.length;
function Ud(e) {
	return (t) => Promise.all(t.map(({ animation: n, options: r }) => Wd(e, n, r)));
}
function Hd(e) {
	let t = Ud(e);
	const n = Yd();
...
const Jd = { animation: { Feature: Xd }, exit: { Feature: Zd } },
	Lo = (e, t) => Math.abs(e - t);
function Qd(e, t) {
	const n = Lo(e.x, t.x),
		r = Lo(e.y, t.y);
...
function On({ point: e }, t) {
	return { point: e, delta: Do(e, xa(t)), offset: Do(e, eh(t)), velocity: th(t, 0.1) };
}
function eh(e) {
	return e[0];
}
...
function No(e, t, n, r = 0.5) {
	(e.origin = r),
		...
		(e.scale = de(n) / de(t)),
		(fr(e.scale, 1, 1e-4) || isNaN(e.scale)) && (e.scale = 1),
		(e.translate = Z(n.min, n.max, e.origin) - e.originPoint),
		(fr(e.translate) || isNaN(e.translate)) && (e.translate = 0);
}
function Tt(e, t, n, r) {
...
function oh(e, { top: t, left: n, bottom: r, right: o }) {
...
function Be(e) {
	return hr(e) || Pa(e) || e.z || e.rotate || e.rotateX || e.rotateY;
}
function Pa(e) {
...
function fh(e, t, n, r = !1) {
	...
	for (let a = 0; a < o; a++) {
		...
		(l && l.style && l.style.display === 'contents') ||
			...
			i && ((t.x *= i.x.scale), (t.y *= i.y.scale), Ta(e, i)),
...
function Go(e, t, [n, r, o]) {
	const s = t[o] !== void 0 ? t[o] : 0.5,
		i = Z(e.min, e.max, s);
	pr(e, t[n], t[r], i, t.scale);
}
const dh = ['x', 'scaleX', 'originX'],
	hh = ['y', 'scaleY', 'originY'];
function lt(e, t) {
	Go(e.x, t, dh), Go(e.y, t, hh);
}
function Sa(e, t) {
	return wa(ch(e.getBoundingClientRect(), t));
}
function ph(e, t, n) {
	const r = Sa(e, n),
		{ scroll: o } = t;
...
class gh {
	...
	updateAxis(t, n, r) {
		...
		this.constraints && this.constraints[t] && (i = rh(i, this.constraints[t], this.elastic[t])),
			s.set(i);
	}
	resolveConstraints() {
		...
		t && it(t)
			...
			: t && r
			? (this.constraints = oh(r.layoutBox, t))
			: (this.constraints = !1),
			(this.elastic = lh(n)),
			o !== this.constraints &&
				r &&
				...
				ge((s) => {
					this.getAxisMotionValue(s) &&
						(this.constraints[s] = ah(r.layoutBox[s], this.constraints[s]));
				});
	}
	resolveRefConstraints() {
		...
		const s = ph(r, o.root, this.visualElement.getTransformPagePoint());
		let i = ih(o.layout.layoutBox, s);
		if (n) {
			const a = n(uh(i));
			(this.hasMutatedConstraints = !!a), a && (i = wa(a));
		}
		return i;
	}
	startAnimation(t) {
	...
	scalePositionWithinConstraints() {
		...
		ge((i) => {
			...
			if (a) {
				const l = a.get();
				o[i] = sh({ min: l, max: l }, this.constraints[i]);
			}
		});
...
class bh extends Fe {
	...
	onPointerDown(t) {
		this.session = new ba(t, this.createPanHandlers(), {
...
function Ca(e) {
	const [t, n] = xh(),
		r = m.useContext(Mr);
	return q.createElement(Ph, {
		...e,
		layoutGroup: r,
		switchLayoutGroup: m.useContext(xs),
		isPresent: t,
		safeToRemove: n,
	});
}
...
function Ch(e, t, n, r, o, s) {
	o
		? ((e.opacity = Z(0, n.opacity !== void 0 ? n.opacity : 1, Eh(r))),
		  (e.opacityExit = Z(t.opacity !== void 0 ? t.opacity : 1, 0, $h(r))))
		: s &&
		  (e.opacity = Z(
...
function Ah(e, t = 0, n = 1, r = 0.5, o, s = e, i = e) {
	if (
...
function ti(e, t, [n, r, o], s, i) {
	Ah(e, t[n], t[r], t[o], t.scale, s, i);
}
const Mh = ['x', 'scaleX', 'originX'],
	kh = ['y', 'scaleY', 'originY'];
function ni(e, t, n, r) {
	ti(e.x, t, Mh, n ? n.x : void 0, r ? r.x : void 0),
		ti(e.y, t, kh, n ? n.y : void 0, r ? r.y : void 0);
}
function ri(e) {
...
function ka({
	...
	return class {
		constructor(i = {}, a = t?.()) {
			...
			this.root === this && (this.nodes = new Dh());
		}
		...
		mount(i, a = this.root.hasTreeAnimated) {
			...
			(this.isSVG = Oh(i)), (this.instance = i);
				...
				this.options.animate !== !1 &&
					...
					this.addEventListener(
						...
						({ delta: f, hasLayoutChanged: d, hasRelativeTargetChanged: h, layout: v }) => {
							...
							const y = this.options.transition || c.getDefaultTransition() || Qh,
								{ onLayoutAnimationStart: b, onLayoutAnimationComplete: C } = c.getProps(),
								S = !this.targetLayout || !Ma(this.targetLayout, v) || h,
								w = !d && h;
							if (
								...
								const A = { ...pa(y, 'layout'), onPlay: b, onComplete: C };
		...
		startUpdate() {
			this.isUpdateBlocked() ||
				((this.isUpdating = !0), this.nodes && this.nodes.forEach(Xh), this.animationId++);
		}
		...
		update() {
			...
			this.isUpdating || this.nodes.forEach(Uh),
				(this.isUpdating = !1),
		...
		clearAllSnapshots() {
			this.nodes.forEach(Kh), this.sharedNodes.forEach(qh);
		}
				...
				if (!(!this.relativeTarget && !this.targetDelta)) {
					if (
						...
						this.relativeParent.target
							? (this.forceRelativeParentToResolveTarget(),
							  nh(this.target, this.relativeTarget, this.relativeParent.target))
							: this.targetDelta
							? (this.resumingFrom
		...
		getClosestProjectingParent() {
			if (!(!this.parent || hr(this.parent.latestValues) || Pa(this.parent.latestValues)))
		...
		calcProjection() {
			...
			const d = this.treeScale.x,
				h = this.treeScale.y;
			fh(this.layoutCorrected, this.treeScale, this.path, l),
				a.layout &&
					!a.target &&
		...
		setAnimationOrigin(i, a = !1) {
			...
			const d = ne(),
				...
				S = !!(y && !C && this.options.crossfade === !0 && !this.path.some(Jh));
			this.animationProgress = 0;
			let w;
			(this.mixTargetDelta = (A) => {
				...
				ci(f.x, i.x, M),
					...
					this.relativeTarget &&
						...
						Zh(this.relativeTarget, this.relativeTargetOrigin, d, M),
						w && Vh(this.relativeTarget, w) && (this.isProjectionDirty = !1),
						w || (w = ne()),
						he(w, this.relativeTarget)),
					y && ((this.animationValues = c), Ch(c, u, this.latestValues, M, S, C)),
		...
		applyTransformsToTarget() {
			...
			if (!(!a || !l || !u)) {
				if (
					...
					this.layout &&
					u &&
					Va(this.options.animationType, this.layout.layoutBox, u.layoutBox)
				) {
					l = this.target || ne();
		...
		registerSharedNode(i, a) {
			this.sharedNodes.has(i) || this.sharedNodes.set(i, new Rh()), this.sharedNodes.get(i).add(a);
...
function Va(e, t, n) {
	return e === 'position' || (e === 'preserve-aspect' && !fr(oi(t), oi(n), 0.2));
}
const tp = ka({
	...
	np = { pan: { Feature: bh }, drag: { Feature: yh, ProjectionNode: Ra, MeasureLayout: Ca } },
...
function mr(e, t, n = 1) {
	...
	if (s) {
		const i = s.trim();
		return ma(i) ? parseFloat(i) : i;
	} else return or(o) ? mr(o, t, n + 1) : o;
}
function ip(e, { ...t }, n) {
	const r = e.current;
...
const fp = (e, t, n) => {
	...
	dp = (e, t, n = {}, r = {}) => {
		(t = { ...t }), (r = { ...r });
		const o = Object.keys(t).filter(La);
		let s = [],
			i = !1;
		const a = [];
		if (
...
function hp(e, t, n, r) {
	return ap(t) ? dp(e, t, n, r) : { target: t, transitionEnd: r };
}
const pp = (e, t, n, r) => {
		const o = ip(e, t, r);
		return (t = o.target), (r = o.transitionEnd), hp(e, t, n, r);
	},
	gr = { current: null },
	Da = { current: !1 };
function mp() {
...
class wp extends Fa {
	readValueFromInstance(t, n) {
		if (Xe.has(n)) {
			...
			const r = xp(t),
				o = (Ts(n) ? r.getPropertyValue(n) : r[n]) || 0;
...
class Pp extends Fa {
	...
	readValueFromInstance(t, n) {
		...
		return (n = ks.has(n) ? n : Nr(n)), t.getAttribute(n);
	}
...
const Tp = (e, t) =>
		kr(e)
			? new Pp(t, { enableHardwareAcceleration: !1 })
			: new wp(t, { enableHardwareAcceleration: !0 }),
	Sp = { layout: { ProjectionNode: Ra, MeasureLayout: Ca } },
	Cp = { ...Jd, ...yf, ...np, ...Sp },
	Oa = Ec((e, t) => of(e, t, Cp, Tp));
function Ia() {
	const e = m.useRef(!1);
	return (
		Er(
...
function Ap({ children: e, isPresent: t }) {
	const n = m.useId(),
		r = m.useRef(null),
	...
	return (
		...
		m.createElement($p, { isPresent: t, childRef: r, sizeRef: o }, m.cloneElement(e, { ref: r }))
	);
}
const Bn = ({
	children: e,
	...
	return (
		...
		i === 'popLayout' && (e = m.createElement(Ap, { isPresent: n }, e)),
...
const Lp = ({
	...
	const a = m.useContext(Mr).forceRender || Ep()[0],
		l = Ia(),
		u = Rp(e);
	let c = u;
	...
	if (
		(Er(() => {
			(v.current = !1), Vp(u, h), (d.current = c);
		}),
		kp(() => {
...
function Dp(e, t) {
	...
	let { pressProps: C, isPressed: S } = ms({
			onPressStart: s,
			onPressEnd: i,
			onPressChange: a,
			onPress: o,
		...
		{ focusableProps: w } = qi(e, t);
	u && (w.tabIndex = r ? -1 : w.tabIndex);
	let A = ue(w, C, Ni(e, { labelable: !0 }));
	return {
		isPressed: S,
		buttonProps: ue(b, A, {
...
function Np(e = {}) {
	let { isReadOnly: t } = e,
		[n, r] = Ri(e.isSelected, e.defaultSelected || !1, e.onChange);
	function o(i) {
		t || r(i);
	}
	function s() {
...
function Fp(e, t) {
	...
	let { focusableProps: c } = qi(e, t),
		{ pressProps: f, isPressed: d } = ms({
			onPress: r,
			onPressStart: o,
			onPressEnd: s,
			isDisabled: a,
...
function Op(e) {
	...
	const [r, o] = Zi(e, uo.variantKeys),
		...
		{ isFocused: M, isFocusVisible: N, focusProps: D } = Xi({ autoFocus: f });
	u &&
...
var ja = De((e, t) => {
	const {
		...
		children: r,
		showAnchorIcon: o,
		anchorIcon: s = O.jsx(vc, { className: qu }),
		getLinkProps: i,
	} = Op({ ref: t, ...e });
	return O.jsx(n, { ...i(), children: O.jsxs(O.Fragment, { children: [r, o && s] }) });
});
ja.displayName = 'NextUI.Link';
var vr = ja,
...
var _a = Up(),
	...
	wn = m.forwardRef(function (e, t) {
		var n = m.useRef(null),
			r = m.useState({ onScrollCapture: _n, onWheelCapture: _n, onTouchMoveCapture: _n }),
			o = r[0],
			s = r[1],
			i = e.forwardProps,
			a = e.children,
...
var Zp = function () {
	...
	tm = function (e) {
		if ((e === void 0 && (e = 'margin'), typeof window > 'u')) return Qp;
		var t = em(e),
...
`
	...
	om = function (e) {
		...
		return m.createElement(nm, { styles: rm(s, !t, o, n ? '' : '!important') });
	},
	yr = !1;
if (typeof window < 'u')
	try {
...
var Qe = yr ? { passive: !1 } : !1,
	...
	Ua = function (e, t) {
		return e === 'v' ? lm(t) : um(t);
	},
	cm = function (e, t) {
		return e === 'h' && t === 'rtl' ? -1 : 1;
	},
	fm = function (e, t, n, r, o) {
		var s = cm(e, window.getComputedStyle(t).direction),
			i = s * r,
			a = n.target,
			l = t.contains(a),
			u = !1,
...
function mm(e) {
		...
		m.useEffect(
			function () {
				if (e.inert) {
					...
					var y = Il([e.lockRef.current], (e.shards || []).map(Si), !0).filter(Boolean);
					return (
	...
	var a = m.useCallback(function (y, b) {
		...
		u = m.useCallback(function (y, b, C, S) {
			var w = { name: y, delta: b, target: C, should: S, shadowParent: gm(C) };
			t.current.push(w),
				setTimeout(function () {
	...
	return m.createElement(
		m.Fragment,
		null,
		v ? m.createElement(s, { styles: hm(o) }) : null,
		h ? m.createElement(om, { gapMode: e.gapMode }) : null
	);
}
function gm(e) {
...
const vm = Hp(_a, mm);
var Ha = m.forwardRef(function (e, t) {
	return m.createElement(wn, ve({}, e, { ref: t, sideCar: vm }));
});
Ha.classNames = wn.classNames;
const ym = Ha;
var [bm, ht] = Zu({
		name: 'NavbarContext',
		strict: !0,
	...
	Ga = De((e, t) => {
		...
		const { className: o, children: s, portalContainer: i, motionProps: a, style: l, ...u } = e,
			...
			C = m.useCallback(
				({ children: w }) =>
					O.jsx(ym, { forwardProps: !0, enabled: d, removeScrollBar: !1, children: w }),
				[d]
			),
			S = v
				? O.jsx(C, {
		...
		return O.jsx(hu, { portalContainer: i, children: S });
	});
Ga.displayName = 'NextUI.NavbarMenu';
var Ya = Ga,
	wm = {
...
var Xa = De((e, t) => {
	const { children: n, ...r } = e,
		...
		[i, a] = sc(n, Ya),
		l = O.jsxs(O.Fragment, {
			children: [O.jsx('header', { ...o.getWrapperProps(), children: i }), a],
		});
	return O.jsx(bm, {
		value: o,
		children: o.shouldHideOnScroll
			...
			: O.jsx(s, { ...o.getBaseProps(), children: l }),
	});
});
Xa.displayName = 'NextUI.Navbar';
var Cm = Xa,
	qa = De((e, t) => {
		var n;
...
qa.displayName = 'NextUI.NavbarBrand';
var Em = qa,
	Za = De((e, t) => {
		var n;
...
Za.displayName = 'NextUI.NavbarContent';
var $m = Za,
	Ja = De((e, t) => {
		var n;
...
Ja.displayName = 'NextUI.NavbarItem';
var Am = Ja,
	Qa = De((e, t) => {
		var n;
...
Qa.displayName = 'NextUI.NavbarMenuItem';
var Mm = Qa;
function km(e, t, n) {
	const { isSelected: r } = t,
		{ isPressed: o, buttonProps: s } = Dp({ ...e, onPress: Di(t.toggle, e.onPress) }, n);
...
var el = De((e, t) => {
	...
	const { as: r, icon: o, className: s, onChange: i, autoFocus: a, srOnlyText: l, ...u } = e,
		...
		{ buttonProps: S, isPressed: w } = km(e, C, f),
		{ isFocusVisible: A, focusProps: M } = Xi({ autoFocus: a }),
		{ isHovered: N, hoverProps: D } = Zl({}),
		p = Pe(h?.toggle, s),
		k = m.useMemo(
			() =>
				typeof o == 'function'
					? o(v ?? !1)
					: o || O.jsx('span', { className: d.toggleIcon({ class: h?.toggleIcon }) }),
	...
	return O.jsxs(c, {
		...
		'data-pressed': le(w),
		...ue(S, M, D, u),
		children: [O.jsx('span', { className: d.srOnly(), children: _ }), k],
	});
});
el.displayName = 'NextUI.NavbarMenuToggle';
var Vm = el;
const Ei = (e, t) => {
	...
	return O.jsxs(vr, {
		...
		children: [
			...
			O.jsxs('div', {
				...
				children: [
					O.jsx('p', { className: `text-foreground-200 ${n[e]}`, children: 'Div' }),
					O.jsx('p', { className: `text-primary-500 ${n[e]}`, children: 'Software' }),
				],
			}),
			O.jsx('img', {
				src: $i,
...
function Nm() {
	...
	return O.jsxs(Cm, {
		...
		children: [
			O.jsx(Em, { children: O.jsx(Rm, { size: 'small' }) }),
			O.jsx(Vm, { 'aria-label': e ? 'Close menu' : 'Open menu', className: 'sm:hidden' }),
			O.jsx($m, {
