...
function Xu(e, n, t, r) {
	if (Or) {
		...
		if (l === null) Rl(e, n, r, Dr, t), Ho(e, r);
			...
			for (; l !== null; ) {
				var u = Gt(l);
				if ((u !== null && Cs(u), (u = ou(e, n, t, r)), u === null && Rl(e, n, r, Dr, t), u === l))
					break;
				l = u;
			}
			...
			P &&
				(Ls &&
					...
					(Dn || P !== 'onCompositionStart'
						...
						: ((be = v), (Gu = 'value' in be ? be.value : be.textContent), (Dn = !0))),
				(_ = Ir(c, P)),
				0 < _.length &&
...
var yd = Xi.exports;
const wd = Ui(yd);
export { wd as $, gd as R, yd as a, Yi as r };
